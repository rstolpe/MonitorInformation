...
[string]$LicenseUrl = "https://github.com/rstolpe/MonitorInformation/blob/main/LICENSE"
[string]$ProjectUrl = "https://github.com/rstolpe/MonitorInformation"
[string]$ReleaseNotesUrl = "https://github.com/rstolpe/MonitorInformation/releases"
[string]$Description = "Returns monitor information from Windows computers, both from local and remote computers"
[bool]$Publish = $false
